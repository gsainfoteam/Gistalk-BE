...
export class LectureService {
    ...
    async createProfLecture(createLectureDto : CreateLectureDto): Promise<Lecture>//Promise<Lecture>
    {
        const { lecture_name, lecture_code, division_field, prof_name } = createLectureDto;
        ...
        if(found)
        {
            ...
            lecture.prof = await this.profRepository.findOne({//porf inject
                relations: {
                    lectures : true
                },
                where : {
